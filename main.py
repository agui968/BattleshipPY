...
#objects created
my_board_obj=classes.Board()
opp_hidden_board_obj=classes.Board() #not visible for player
opp_shots_board_obj=classes.Board()
...
# update the board with the method to place a boat (a randomized boat) from a class instance
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(4,myboats),my_board)
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(3,myboats),my_board)
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(3,myboats),my_board)
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(2,myboats),my_board)
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(2,myboats),my_board)
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(2,myboats),my_board)
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(1,myboats),my_board)
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(1,myboats),my_board)
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(1,myboats),my_board)
my_board=my_board_obj.place_boat(my_board_obj.randomize_boat(1,myboats),my_board)

#PLACING THE MACHINE'S BOATS (main version)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(4,oppboats),opp_hidden_board)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(3,oppboats),opp_hidden_board)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(3,oppboats),opp_hidden_board)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(2,oppboats),opp_hidden_board)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(2,oppboats),opp_hidden_board)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(2,oppboats),opp_hidden_board)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(1,oppboats),opp_hidden_board)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(1,oppboats),opp_hidden_board)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(1,oppboats),opp_hidden_board)
opp_hidden_board=opp_hidden_board_obj.place_boat(opp_hidden_board_obj.randomize_boat(1,oppboats),opp_hidden_board)
...
def playgame():
    ...
    #                         opplives=3
    #                         #we would hav to reset the boards and generate new ships
